...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: "E-mail",
      info: "contato@faculdademarinho.edu.br\nvestibular@faculdademarinho.edu.br"
    },
    {
      icon: Clock,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Pronto para transformar seu futuro? Entre em contato conosco e descubra 
            como a Faculdade Marinho pode ajudar você a alcançar seus objetivos.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <Card className="shadow-elegant border-none">
            ...
            <CardContent className="space-y-6">
              ...
              <Button 
                size="lg" 
                className="w-full bg-primary hover:bg-orange-dark text-white shadow-orange"
              >
                Enviar Mensagem
              </Button>
            </CardContent>
              ...
              <div className="h-64 bg-gradient-to-br from-primary/20 to-orange-light/20 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-foreground font-semibold">
                    Localização da Faculdade Marinho
                  </p>
        ...
        <div className="mt-16 text-center bg-gradient-hero rounded-2xl p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Faça sua inscrição hoje mesmo e transforme seu futuro profissional.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-white text-black hover:bg-gray-100 hover:text-black"
            >
              Agendar Visita
            </Button>
          </div>
